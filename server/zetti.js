...
class Zetti
{
  ...
  * */
  ...
  async take_guesses(/*array*/players, /*number*/starter_index, playingfield)
  {
    ...
    for (let i = 0; i < players.length; i++)
    {
      ...
      await new Promise( (resolve) => {
        // resolve can be triggered from outside by  call 'take_next_guess()' in 'this.game_io.on('guess.response')';
        /*global variable*/ this.take_next_guess = resolve; 
      });
  ...
  to_serve(/*array*/trick)
  {
    ...
    // der Only-Enno Fall
    // debug_stream.write("der Only-Enno Fall");
